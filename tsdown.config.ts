...
export default defineConfig([
  ...
  nodeBuildConfig({
    ...
    entry: {
      ...
      "discord/channel-actions": "extensions/discord/src/channel-actions.ts",
      "whatsapp/agent-tools-login": "extensions/whatsapp/src/agent-tools-login.ts",
      "signal/accounts": "extensions/signal/src/accounts.ts",
      "signal/reaction-level": "extensions/signal/src/reaction-level.ts",
      "signal/send-reactions": "extensions/signal/src/send-reactions.ts",
